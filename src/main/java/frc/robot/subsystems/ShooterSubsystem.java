...
public class ShooterSubsystem {
    ...
    private TalonFX highLeft = new TalonFX(0); //not sure if these should be on the left or the right
    private TalonFX midRight = new TalonFX(0); //but there is sparkmax low, then talon on either side
