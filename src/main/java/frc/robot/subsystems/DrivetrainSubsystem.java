...
public class DrivetrainSubsystem {
  ...
  */
  ...
  private SwerveDrivePoseEstimator odometry; //TODO: explain what this is and how we use it
  private Pose2d pose; //TODO: explain what this is and how we use it //TODO: refactor code to replace this
  private ShuffleboardTab tab;

  //ChassisSpeeds takes in y velocity, x velocity, speed of rotation
  private ChassisSpeeds chassisSpeeds; //TODO: explain what this is and how we use it
  ...
  public void init(){ //TODO: is the naming this init an issue? check with Kim
        ...
        pose = new Pose2d(); //TODO: why does this differ from the pose we feed into odometry?
  ...
  public void resetOdometry(Pose2d start){ //TODO: look over this method and confirm use
        ...
        pose = start; //TODO: taken from elsewhere, confirm why we do this
        odometry.resetPosition(getGyroscopeRotation(), positionArray, pose);
        pose = odometry.update(getGyroscopeRotation(), positionArray);
}
...
public void setSpeed(ChassisSpeeds chassisSpeed) { 
  ...
  public void drive() { //runs periodically
        ...
        pose = odometry.update(getGyroscopeRotation(), modulePositions); 
  ...
  private static double deadband(double value, double deadband) {
    ...
    public void stopDrive() {
        //TODO: always log something very explicit and scary here
