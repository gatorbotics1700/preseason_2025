...
public class Paths {
    ...
    public enum AUTO_OPTIONS{
     ...
     //3 = middle of speaker
        ...
        R_THREE_PIECE_2_ALT,
        B_THREE_PIECE_2_ALT,
        R_ONE_PIECE_AMP, //DONT CHANGE UNLESS YOU TALK TO AUTO LEAD
        B_ONE_PIECE_AMP,
        R_TWO_AMP,
        B_TWO_AMP,
        B_VOMIT,
    ...
    private static final double TOP_NOTE_Y = (277.5-2) * Constants.METERS_PER_INCH;
    ...
    private static final double R_FARTHEST_NOTE_LINEUP_X = 379 * Constants.METERS_PER_INCH;
    ...
    public static AutonomousBase constructAuto(AUTO_OPTIONS selectedAuto){
        if(selectedAuto == AUTO_OPTIONS.PD_TESTPATH){
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(140 * Constants.METERS_PER_INCH, 0, RED_DRIVERSTATION)),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(140 * Constants.METERS_PER_INCH, 0, new Rotation2d(Math.toRadians(90)))),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(140 * Constants.METERS_PER_INCH, 0, RED_DRIVERSTATION)),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(100 * Constants.METERS_PER_INCH, 0, RED_DRIVERSTATION)),
        ...
        }else if(selectedAuto == AUTO_OPTIONS.R_ONE_PIECE_AMP){ //DONT CHANGE UNLESS YOU TALK TO AN AUTO LEAD
            return new AutonomousBasePD(
                RED_AMP_STARTING_POSE,
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_STARTING_X, AMP_ENDING_Y, AMP_ANGLE)), //basically where the amp is - our length
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //moves up to amp
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(R_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //moves up to amp
                    new PDState(AutoStates.SHOOTING_AMP), //shoots preloaded piece into amp
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_ENDING_X, AMP_ENDING_Y, AMP_ANGLE)), //moves away from amp
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_ENDING_X, AMP_ENDING_Y, RED_DRIVERSTATION)), //sets true north to correct angle away from amp
                    new PDState(AutoStates.STOP) 
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_STARTING_X, AMP_ENDING_Y, AMP_ANGLE)), //basically where the amp is - our length
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //moves up to amp
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //moves up to amp
                    new PDState(AutoStates.SHOOTING_AMP), //shoots preloaded piece into amp
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_ENDING_X, AMP_ENDING_Y, AMP_ANGLE)), //moves away from amp
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_ENDING_X, AMP_ENDING_Y, BLUE_DRIVERSTATION)), //sets true north to correct angle
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_LEAVE_ENDING_X, LEAVE_STARTING_Y, RED_DRIVERSTATION)),
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_LEAVE_ENDING_X, LEAVE_STARTING_Y, BLUE_DRIVERSTATION)),
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(R_AMP_X + (4*Constants.METERS_PER_INCH), AMP_ENDING_Y - (0*Constants.METERS_PER_INCH), AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X + (4*Constants.METERS_PER_INCH), AMP_ENDING_Y - (0*Constants.METERS_PER_INCH), RED_DRIVERSTATION)), //move y
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_INTAKING_X, TOP_NOTE_Y, AMP_ANGLE)), //turn
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, TOP_NOTE_Y, AMP_ANGLE)), //move x
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, BLUE_DRIVERSTATION)), //move y
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, FARTHEST_NOTE_Y, AMP_ANGLE)), //turn
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, FARTHEST_NOTE_Y, AMP_ANGLE)), //move x
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, BLUE_DRIVERSTATION)), //move y
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_STARTING_X, AMP_ENDING_Y + (2*Constants.METERS_PER_INCH), AMP_ANGLE)), //basically where the amp is - our length
                  ...
                  //  new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(R_AMP_X, FARTHEST_NOTE_Y + (2*Constants.METERS_PER_INCH), AMP_ANGLE)), //moves away from amp
                    ...
                    new PDState(AutoStates.HOLDING_TIMED, new Pose2d(R_AMP_X, AMP_ENDING_Y + (19*Constants.METERS_PER_INCH), AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X, AMP_ENDING_Y + (19*Constants.METERS_PER_INCH), RED_DRIVERSTATION)), //move y
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, SECOND_FARTHEST_NOTE_Y, BLUE_DRIVERSTATION)), //intake
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, SECOND_FARTHEST_NOTE_Y, AMP_ANGLE)), //turn
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, FARTHEST_NOTE_Y, AMP_ANGLE)), 
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, FARTHEST_NOTE_Y, AMP_ANGLE)), //move x
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.STOP)
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, SECOND_FARTHEST_NOTE_Y, RED_DRIVERSTATION)), //intake
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, SECOND_FARTHEST_NOTE_Y, AMP_ANGLE)), //turn
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, FARTHEST_NOTE_Y, AMP_ANGLE)), //TURN
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X, FARTHEST_NOTE_Y, AMP_ANGLE)), //move x
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //move y
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_STARTING_X, AMP_ENDING_Y, AMP_ANGLE)), //basically where the amp is - our length
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(B_AMP_X, AMP_ENDING_Y, AMP_ANGLE)), //
                    new PDState(AutoStates.SHOOTING_AMP),
                    ...
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, FARTHEST_NOTE_Y, BLUE_DRIVERSTATION)), //INTAKE
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(214*Constants.METERS_PER_INCH, FARTHEST_NOTE_Y, BLUE_DRIVERSTATION)), //
                    new PDState(AutoStates.SHOOTING_AMP),
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(SECOND_FARTHEST_NOTE_INTAKING_X, 260*Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), //
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(214*Constants.METERS_PER_INCH, 260*Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), // 
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.STOP)
                }
            );
            ...
            return new AutonomousBasePD(
                ...
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_STARTING_X, AMP_ENDING_Y, AMP_ANGLE)), //basically where the amp is - our length
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(R_AMP_X, AMP_ENDING_Y, AMP_ANGLE)),
                    new PDState(AutoStates.SHOOTING_AMP),
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(475*Constants.METERS_PER_INCH, FARTHEST_NOTE_Y, RED_DRIVERSTATION)), //
                    new PDState(AutoStates.SHOOTING_AMP),
                    ...
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(330*Constants.METERS_PER_INCH, 260*Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(475*Constants.METERS_PER_INCH, 260*Constants.METERS_PER_INCH, RED_DRIVERSTATION)), // 
                    new PDState(AutoStates.DRIVE_MECH_OFF, new Pose2d(475*Constants.METERS_PER_INCH, 260*Constants.METERS_PER_INCH, RED_DRIVERSTATION)), // 
                    new PDState(AutoStates.SHOOTING_AMP),
                    new PDState(AutoStates.STOP)
                }
            );
        }else if(selectedAuto == AUTO_OPTIONS.R_COMP_THREE_PIECE){
            return new AutonomousBasePD(
                new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION),
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(43.3)))),
                    new PDState(AutoStates.SHOOTING_SPEAKER),
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //turn back
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(587.65 * Constants.METERS_PER_INCH, 29.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(337.15 * Constants.METERS_PER_INCH, 29.64  * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //intake
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 29.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)),
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(43.3)))), //turn
                    new PDState(AutoStates.SHOOTING_SPEAKER),
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //turn back
                    //cut here to make 2 piece
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(587.65 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(370 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(370 * Constants.METERS_PER_INCH, 95.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(337.15 * Constants.METERS_PER_INCH, 95.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //intake
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(337.15 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(43.3)))), //turn
                    new PDState(AutoStates.SHOOTING_SPEAKER),
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(587.65 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //turn back
        ...
        }else if(selectedAuto == AUTO_OPTIONS.B_COMP_THREE_PIECE){
            return new AutonomousBasePD(
                new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION),
                new PDState[]{
                    new PDState(AutoStates.FIRST),
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(223.3)))),
                    new PDState(AutoStates.SHOOTING_SPEAKER),
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(63.6  * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), //turn back
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(63.6 * Constants.METERS_PER_INCH, 29.64 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(314.1 * Constants.METERS_PER_INCH, 29.64  * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), //intake
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 29.64 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), 
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)),
                    new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(223.3)))), //turn
                    new PDState(AutoStates.SHOOTING_SPEAKER),
                    new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, BLUE_DRIVERSTATION)), //turn back
                     //cut here to make 2 piece
                     new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(63.6 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(281.25 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(281.25 * Constants.METERS_PER_INCH, 95.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(314.1 * Constants.METERS_PER_INCH, 95.64 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //intake
                     new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(314.1 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 76 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), 
                     new PDState(AutoStates.DRIVE_WITH_HOLDING_SPEAKER, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, new Rotation2d(Math.toRadians(43.3)))), //turn
                     new PDState(AutoStates.SHOOTING_SPEAKER),
                     new PDState(AutoStates.DRIVE_WITH_INTAKING, new Pose2d(63.6 * Constants.METERS_PER_INCH, 161.5 * Constants.METERS_PER_INCH, RED_DRIVERSTATION)), //turn back
                     new PDState(AutoStates.STOP)
